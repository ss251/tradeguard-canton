...
| **0:50–1:40** | ACT 3 | "The agent computes the multilateral net and proposes the minimal residual settlement. A human approves on-ledger — the agent never moves assets alone. Then one atomic transaction discharges all twelve obligations and moves only the residual cash. **565 gross becomes 100 — over 82% never moves.**" |
